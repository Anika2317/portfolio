...
| 📝 **Homework Lessons** | All assignments mapped to rubric | [Open Hub]({{ '/cs111/2026/03/18/index.html' | relative_url }}) |
| 🏰 **FA1 & FA2** | SkyKingdom + Interaction Design | [Open]({{ '/cs111/2026/03/18/cs111-accounts.html' | relative_url }}) |
| 🐺 **Red Riding Hood** | Final Project — Full Engine Architecture | [Open]({{ '/cs111/setup' | relative_url }}) |
