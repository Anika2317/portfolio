...
permalink: /games/red-riding/docs/RedRiding
---
...
# 🐺 Red Riding Hood: CS111 Evidence

| Requirement | Evidence File(s) | Status |
|:---|:---|:---|
| **Class Hierarchy** | `Player.js`, `Wolf.js` (extending `Character`) | ✅ |
| **Method Overriding** | `update()`, `draw()`, `handleCollision()` | ✅ |
| **Constructor Chaining** | `super(data, gameEnv)` calls | ✅ |
| **API Integration** | `fetch` calls in `red-riding` | ✅ |
| **Debug Evidence** | Network/Console logs used | ✅ |
